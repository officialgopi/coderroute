    ...
    return (
        <div ref={containerRef} className="relative inline-flex items-center">
            ...
            >
                ...
                <ChevronDown size={12} className={`text-text-muted transition-transform ${isMenuOpen ? "rotate-180" : ""}`} />
            </button>
            ...
            <AnimatePresence>
                {isMenuOpen && (
                    <motion.div
                        ...
                        className="absolute right-0 top-9 w-48 bg-bg-secondary/75 backdrop-blur-md border border-border-subtle rounded-xl shadow-2xl p-1.5 text-text-primary z-50 overflow-hidden"
                    >
                        <Link
                            to={`/${user.username}`}
